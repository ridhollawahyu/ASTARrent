...
<div class="print-header">
    ...
    <h5>Tipe Laporan: Laporan Peminjaman & Denda (Finance)</h5>
...
<ul class="nav nav-tabs mb-3 border-bottom-0 gap-1 no-print">
    <li class="nav-item">
        <a class="nav-link active fw-bold text-astar border border-bottom-0 px-4 py-2" href="laporan_peminjaman.php" style="border-radius: 8px 8px 0 0; background-color: #fff; border-color: #dee2e6 #dee2e6 #fff;">Peminjaman & Denda</a>
    </li>
    <li class="nav-item">
        <a class="nav-link fw-bold text-secondary px-4 py-2 border border-bottom-0" href="laporan_pengadaan.php" style="border-radius: 8px 8px 0 0; border-color: transparent;">Pengadaan Aset</a>
    </li>
</ul>
...
<div class="card shadow-sm border-0 no-print" style="border-radius: 15px; margin-bottom: 25px;">
    <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #1d4197; border-top-left-radius: 15px; border-top-right-radius: 15px;">
        <h5 class="mb-0 text-white fw-bold"><i class="bi bi-cash-stack me-2"></i>Laporan Peminjaman & Denda</h5>
        ...
        <form method="GET" action="" class="row g-3">
            ...
            <div class="col-12 d-flex justify-content-between mt-4">
                <div>
                    ...
                    <a href="laporan_peminjaman.php" class="btn btn-light border fw-bold text-secondary px-3 ms-2">Reset</a>
                </div>
                <div>
