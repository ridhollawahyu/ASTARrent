                    ...
                    <tbody>
                        ...
                        foreach ($data_report as $row): ?>
                            <tr>
                                ...
                                <td class="text-center"><span class="badge bg-<?= ($row['statusPeminjaman'] == 'Disetujui') ? 'primary' : (($row['statusPeminjaman'] == 'Selesai') ? 'success' : (($row['statusPeminjaman'] == 'Ditolak') ? 'danger' : 'warning text-dark')) ?> rounded-pill px-3 py-2"><?= $row['statusPeminjaman'] ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
