...
<div class="print-header">
    ...
    <h5>Tipe Laporan: Laporan Peminjaman Non-Akademik (Staff GA)</h5>
...
<ul class="nav nav-tabs mb-3 border-bottom-0 gap-1 no-print">
    <li class="nav-item">
        <a class="nav-link active fw-bold text-astar border border-bottom-0 px-4 py-2" href="laporan_peminjaman.php" style="border-radius: 8px 8px 0 0; background-color: #fff; border-color: #dee2e6 #dee2e6 #fff;">Peminjaman</a>
    </li>
    <li class="nav-item">
...
<div class="card shadow-sm border-0 no-print" style="border-radius: 15px; margin-bottom: 25px;">
    <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #1d4197; border-top-left-radius: 15px; border-top-right-radius: 15px;">
        <h5 class="mb-0 text-white fw-bold"><i class="bi bi-journal-list me-2"></i>Laporan Peminjaman Non-Akademik</h5>
