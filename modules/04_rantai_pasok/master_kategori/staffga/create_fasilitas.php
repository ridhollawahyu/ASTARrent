...
if (isset($_POST['submit'])) {
    ...
    $query_simpan = "INSERT INTO kategori (idKategori, namaKategori, tipeKategori, idPembuat) 
                     VALUES ('$id_otomatis', '$nama', 'Fasilitas Non-Akademik', '$id_pembuat')";
            ...
            <div class="card-body p-4">
                ...
                <form action="" method="POST">
                    <div class="mb-6">
                        ...
                        <input type="text" name="nama" class="form-control" required placeholder="Contoh: Komunal, Lapangan, dll.">
                    </div>
                    <div class="mb-6">
                        <label class="form-label text-astar fw-bold">Tipe Kategori </label>
                        <input type="text" name="tipe" class="form-control fw-bold" required value="Fasilitas Non-Akademik" readonly>
                    </div>
