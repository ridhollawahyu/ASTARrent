...
$where_sql = "WHERE statusUser = 'Aktif' AND idUser != 'SA-001'"; // Default: Tampilkan yang Aktif saja
$jabatan_terpilih = "";
...
if (isset($_GET['jabatan']) && $_GET['jabatan'] != '') {
    ...
    if ($jabatan_terpilih == 'Semua_Termasuk_Arsip') {
        $where_sql = "WHERE 1=1 AND idUser != 'SA-001'"; // Tampilkan semua tanpa filter status
    } elseif ($jabatan_terpilih == 'Arsip') {
        $where_sql = "WHERE statusUser = 'Nonaktif' AND idUser != 'SA-001'"; // Filter khusus yang di-soft delete
    } else {
        // Filter berdasarkan Jabatan asli DAN statusnya harus Aktif
        $where_sql = "WHERE jabatanUser = '$jabatan_terpilih' AND statusUser = 'Aktif' AND idUser != 'SA-001'";
    }
}
...
<div class="card shadow-sm border-0" style="border-radius: 15px;">
    ...
    <div class="card-body p-4">
        ...
        <div class="table-responsive">
            <table class="table table-hover table-striped mb-0 text-center align-middle border">
