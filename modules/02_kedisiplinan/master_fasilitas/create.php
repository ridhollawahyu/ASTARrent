...
if (isset($_POST['submit'])) {
    ...
    $query_simpan = "INSERT INTO fasilitas (idFasilitas, idTendik,  idKategori, namaFasilitas, lokasiFasilitas) 
                     VALUES ('$id_otomatis', '$id_tendik', '$kategori', '$nama', '$lokasi')";
            ...
            <div class="card-body p-4">
                ...
                <form action="" method="POST">
                    <div class="mb-3">
                        ...
                        $pilihan_kategori = ambil_pilihan_kategori('Fasilitas');
