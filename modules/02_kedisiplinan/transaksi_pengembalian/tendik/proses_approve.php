<?php
// --- FILE: modules/02_kedisiplinan/transaksi_pengembalian/tendik/proses_approve.php ---
...
if (isset($_POST['submit_pengembalian'])) {
    ...
    // Maka dianggap "Normal" oleh Robot agar tidak ada Denda Kerusakan!
    ...
    // Manipulasi Catatan & Tentukan Sanksi Utama
    ...
    $q_insert = "INSERT INTO transaksi_pengembalian (idPengembalian, idPeminjaman, idPengurus, idSanksi, tanggalPengembalian, kondisiFisik, catatanPengembalian) 
                 VALUES ('$id_pengembalian', '$id_peminjaman', '$id_tendik', $id_sanksi_simpan, '$waktu_sekarang', '$kondisi_fisik', '$catatan')";
...
// PERBAIKAN: Ambil KONDISI FISIK SAAT INI dari tabel Aset/Fasilitas
        ...
        <div class="card shadow-sm border-0" style="border-radius: 15px;">
            ...
            <div class="card-body p-4">
                ...
                <div class="bg-light p-3 rounded border mb-4">
                    ...
                    <!-- TAMBAHAN: INFORMASI KONDISI AWAL -->
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        <label class="form-label text-astar fw-bold">Kondisi Fisik Pasca Pinjam <span class="text-danger">*</span></label>
                        <?php
                        // DROPDOWN DINAMIS BERDASARKAN KONDISI AWAL
