...
$where_sql = "WHERE fasilitas.ketersediaanFasilitas != 'Tidak Tersedia' AND fasilitas.ketersediaanFasilitas != 'Nonaktif' AND fasilitas.tipeFasilitas = 'Non-Akademik'";
...
if (isset($_GET['ketersediaan']) && $_GET['ketersediaan'] != '') {
    ...
    if ($status_terpilih == 'Semua_Termasuk_Arsip') {
        ...
        $where_sql = "WHERE fasilitas.tipeFasilitas = 'Non-Akademik'";
    } else {
        // Tampilkan sesuai yang dipilih user
        $where_sql = "WHERE fasilitas.ketersediaanFasilitas = '$status_terpilih' AND fasilitas.tipeFasilitas = 'Non-Akademik'";
    }
}
    ...
    <div class="card-body p-4">
        ...
        <form method="GET" action="index.php" class="row g-2 align-items-center mb-4 pb-3 border-bottom">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                $pilihan_kategori = ambil_pilihan_kategori('Fasilitas Non-Akademik');
