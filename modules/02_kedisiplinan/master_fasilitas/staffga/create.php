...
if (isset($_POST['submit'])) {
    ...
    $query_simpan = "INSERT INTO fasilitas (idFasilitas, idPengelola, idKategori, namaFasilitas, lokasiFasilitas, tipeFasilitas) 
                     VALUES ('$id_otomatis', '$id_pengelola', '$kategori', '$nama', '$lokasi', 'Non-Akademik')";
            ...
            <div class="card-body p-4">
                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama" class="form-control" required placeholder="Contoh: Komunal Hijau">
                    </div>
