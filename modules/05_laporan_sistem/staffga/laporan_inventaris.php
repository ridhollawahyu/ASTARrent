                    ...
                    <tbody>
                        ...
                        foreach ($data_report as $row): ?>
                            <tr>
                                ...
                                <td class="text-center"><?= ($row['kondisi'] == 'Normal' || $row['kondisi'] == 'Sangat Baik' || $row['kondisi'] == 'Layak Pakai') ? '<span class="text-success fw-bold">' . $row['kondisi'] . '</span>' : '<span class="text-danger fw-bold">' . $row['kondisi'] . '</span>' ?></td>
